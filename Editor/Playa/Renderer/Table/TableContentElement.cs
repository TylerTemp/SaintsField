...
// #endif
                ...
                if (itemIsObject)
                {
                    ...
                    using(SerializedObject serializedObject = new SerializedObject(obj0))
                    {
                        ...
                        IEnumerable<SaintsFieldInfoName> saintsFieldWithInfos = SaintsEditor
                            .HelperGetSaintsFieldWithInfo(_fieldWithInfo.SerializedProperty.serializedObject, serializedPropertyDict, null, null, new []{obj0})
                        ...
                        multiColumnListView.columns.Add(new Column
                        {
                            ...
                            bindCell = (element, index) =>
                            {
                                ...
                                foreach (SaintsFieldWithInfo saintsFieldWithInfo in SaintsEditor
                                             .HelperGetSaintsFieldWithInfo(_fieldWithInfo.SerializedProperty.serializedObject, targetPropertyDict, null, null, new[]{targetPropValue})
                ...
                else  // item is general
                {
                    ...
                    IEnumerable<SaintsFieldWithInfo> firstSaintsFieldWithInfos = SaintsEditor
                        .HelperGetSaintsFieldWithInfo(_fieldWithInfo.SerializedProperty.serializedObject, firstSerializedPropertyDict, null, null, new[]{firstPropValue.value})
                        .Where(SaintsEditor.SaintsFieldInfoShouldDraw);
                    ...
                    foreach (KeyValuePair<string, List<string>> columnKv in columnToMemberIds)
                    {
                        ...
                        curColumn.bindCell = (element, index) =>
                        {
                            ...
                            int serCount = 0;
                            foreach (SaintsFieldWithInfo saintsFieldWithInfo in SaintsEditor
                                         .HelperGetSaintsFieldWithInfo(_fieldWithInfo.SerializedProperty.serializedObject, targetSerializedPropertyDict, null, null, new[]{targetPropValue.value})
                                         .Where(saintsFieldWithInfo => memberIds.Contains(saintsFieldWithInfo.MemberId)))
                            {
