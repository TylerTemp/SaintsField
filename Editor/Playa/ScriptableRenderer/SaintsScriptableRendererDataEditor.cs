...
namespace SaintsField.Editor.Playa.ScriptableRenderer
{
        ...
        // SaintsEditor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            if (editorsField.GetValue(this) is not List<UnityEditor.Editor> outEditors)
            {
                return new HelpBox("Unity upgrade its internal calls. Please report this issue.", HelpBoxMessageType.Error);
            }
            ...
            {
                updateEditorListMethod.Invoke(target, null);
            }
            ...
            addBtn.clicked += () =>
            {
                ...
                FilterWindow.Show(pos, (FilterWindow.IProvider)ctor.Invoke(new object[] { this }));
            };
        ...
        static class ScriptableRendererDataReflection
        {
            static readonly MethodInfo ValidateRendererFeaturesMethod =
                typeof(UnityEngine.Rendering.Universal.ScriptableRendererData)
                    .GetMethod(
                        "ValidateRendererFeatures",
                        BindingFlags.Instance | BindingFlags.NonPublic
                    );

            static readonly MethodInfo RemoveMissingRendererFeaturesMethod =
                typeof(UnityEngine.Rendering.Universal.ScriptableRendererData)
                    .GetMethod(
