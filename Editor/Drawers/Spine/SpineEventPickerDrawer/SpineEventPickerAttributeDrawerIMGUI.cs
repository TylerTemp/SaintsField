...
{
    public partial class SpineEventPickerAttributeDrawer
    {
        ...
        private const string IconPath = "Spine/icon-event.png";
        ...
        private static InfoIMGUI EnsureKey(SerializedProperty property, SpineEventPickerAttribute attribute, FieldInfo info, object parent)
        {
        ...
        private static void RefreshCache(InfoIMGUI cache, SerializedProperty property, SpineEventPickerAttribute attribute, FieldInfo info, object parent)
        {
        ...
        private static AdvancedDropdownMetaInfo GetMetaInfo(string currentValue, SkeletonData skeletonData)
        {
            ...
            {
                options.Add(eventData.Name, eventData.Name, icon: IconPath);
            }
        ...
        private static string GetDisplay(string currentValue, SkeletonData skeletonData)
        {
            ...
            foreach (EventData eventData in skeletonData.Events)
            {
                if (eventData.Name == currentValue)
                {
        ...
        protected override void DrawField(Rect position, SerializedProperty property, GUIContent label,
            ...
            object parent)
        {
            InfoIMGUI cache = EnsureKey(property, (SpineEventPickerAttribute)saintsAttribute, info, parent);
            if (property.propertyType != SerializedPropertyType.String)
            {
        ...
        protected override bool WillDrawBelow(SerializedProperty property, IReadOnlyList<PropertyAttribute> allAttributes,
            ...
            EnsureKey(property, (SpineEventPickerAttribute)saintsAttribute, info, parent).Error != "";
        ...
        {
            string error = EnsureKey(property, (SpineEventPickerAttribute)saintsAttribute, info, parent).Error;
