...
{
    public partial class SpineIkConstraintPickerAttributeDrawer
    {
        ...
        private static InfoIMGUI EnsureKey(SerializedProperty property, SpineIkConstraintPickerAttribute attribute, FieldInfo info, object parent)
        {
        ...
        private static void RefreshCache(InfoIMGUI cache, SerializedProperty property, SpineIkConstraintPickerAttribute attribute, FieldInfo info, object parent)
        {
        ...
        private static AdvancedDropdownMetaInfo GetMetaInfo(string currentValue, SkeletonData skeletonData)
        {
            ...
            foreach (IkConstraintData constraintData in GetIkConstraintData(skeletonData))
            {
        ...
        {
            InfoIMGUI cache = EnsureKey(property, (SpineIkConstraintPickerAttribute)saintsAttribute, info, parent);
            if (property.propertyType != SerializedPropertyType.String)
            {
        ...
        protected override bool WillDrawBelow(SerializedProperty property, IReadOnlyList<PropertyAttribute> allAttributes,
            ...
            EnsureKey(property, (SpineIkConstraintPickerAttribute)saintsAttribute, info, parent).Error != "";
        ...
        {
            string error = EnsureKey(property, (SpineIkConstraintPickerAttribute)saintsAttribute, info, parent).Error;
