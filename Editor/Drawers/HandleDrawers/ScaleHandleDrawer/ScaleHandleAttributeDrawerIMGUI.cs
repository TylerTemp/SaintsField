...
namespace SaintsField.Editor.Drawers.HandleDrawers.ScaleHandleDrawer
{
    public partial class ScaleHandleAttributeDrawer
    {
        ...
        {
            return EnsureKey(property, (ScaleHandleAttribute) saintsAttribute, index, info, parent, allAttributes).Error != "";
        }
        ...
        protected override float GetBelowExtraHeight(SerializedProperty property, GUIContent label,
            ...
            int index, FieldInfo info, object parent)
        {
            string error = EnsureKey(property, (ScaleHandleAttribute) saintsAttribute, index, info, parent, allAttributes).Error;
            return error == ""
                ? 0
