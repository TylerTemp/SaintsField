...
namespace SaintsField.Editor.Drawers.SaintsSerializedActualDrawerDrawer
{
    public partial class SaintsSerializedActualDrawerAttributeDrawer
    {
            ...
            IReadOnlyList<PropertyAttribute> allAttributes, VisualElement container, FieldInfo info, object parent)
        {
            ...
            SaintsSerializedActualAttribute saintsSerializedActual =
                ReflectCache.GetCustomAttributes<SaintsSerializedActualAttribute>(info).First();
            ...
            return element ?? UnityFallbackUIToolkit(info, property,
                allAttributes.Where(each => each is not SaintsSerializedActualDrawerAttribute).ToArray(), container,
                label, SaintsPropertyDrawers, parent);
        }
        ...
        {
            _actualDrawer?.OnAwakeActualDrawer(property, saintsAttribute, index, allAttributes, container,
                onValueChangedCallback, info, parent);
        }

        private (VisualElement element, ISaintsSerializedActualDrawer actualDrawer) RenderSerializedActual(
            SaintsSerializedActualAttribute saintsSerializedActual, string label, SerializedProperty property,
            FieldInfo serInfo, bool inHorizontalLayout, object parent)
        {
            ...
            SaintsPropertyType propertyType =
                (SaintsPropertyType)property.FindPropertyRelative(nameof(SaintsSerializedProperty.propertyType)).intValue;
            ...
            switch (propertyType)
            {
...
#endif
                {
                    ...
                    if (enumToggle != null)
                    {
                        EnumToggleButtonsAttributeDrawer enumToggleButtonsAttributeDrawer =
                            (EnumToggleButtonsAttributeDrawer)MakePropertyDrawer(
                                typeof(EnumToggleButtonsAttributeDrawer), serInfo, enumToggle, label);
                        VisualElement element = enumToggleButtonsAttributeDrawer.RenderSerializedActual(
                            saintsSerializedActual, enumToggle, label, property, serInfo, parent, this);
                ...
                case SaintsPropertyType.Interface:
                    return (SaintsInterfaceDrawer.RenderSerializedActual(saintsSerializedActual,
                        ...
                        (SaintsInterfaceDrawer)MakePropertyDrawer(typeof(SaintsInterfaceDrawer), serInfo, null, label));
                case SaintsPropertyType.DateTime:
                {
                    VisualElement element =
                        DateTimeAttributeDrawer.RenderSerializedActual(dateTimeAttribute, label, property,
                            inHorizontalLayout);
                    return (element,
                        element == null
                            ? null
                            : (DateTimeAttributeDrawer)MakePropertyDrawer(typeof(DateTimeAttributeDrawer), serInfo,
                                dateTimeAttribute, label));
                }
                case SaintsPropertyType.TimeSpan:
                {
                    VisualElement element =
                        TimeSpanAttributeDrawer.RenderSerializedActual(label, property, attributes,
                            inHorizontalLayout);
                    return (element,
                        element == null
                            ? null
                            : (TimeSpanAttributeDrawer)MakePropertyDrawer(typeof(TimeSpanAttributeDrawer), serInfo,
                                timeSpanAttribute, label));
                }
                case SaintsPropertyType.Guid:
                {
                    VisualElement element = GuidAttributeDrawer.RenderSerializedActual(label, property,
                        inHorizontalLayout);
                    return (element,
                        element == null
                            ? null
                            : (GuidAttributeDrawer)MakePropertyDrawer(typeof(GuidAttributeDrawer), serInfo, null,
                                label));
                }
                case SaintsPropertyType.Decimal:
                {
                    ...
                    return (element,
                        element == null
                            ? null
                            : (SaintsDecimalDrawer)MakePropertyDrawer(typeof(SaintsDecimalDrawer), serInfo, null,
                                label));
                }
                default:
