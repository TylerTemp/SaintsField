                ...
                case SourceType.Long:
                    switch (requiredLimit.SourceType)
                    {
                        case SourceType.Long:
                            ...
                            {
                                return ($"Max {requiredLimit.LongV}, get {sourceNumber.LongV}", () => apply(sourceNumber.LongV));
                            }
                            break;
                        case SourceType.Ulong:
                            if (sourceNumber.LongV >= 0 && (ulong)sourceNumber.LongV > requiredLimit.UlongV)
                            {
                                return ($"Max {requiredLimit.UlongV}, get {sourceNumber.LongV}", () => apply(sourceNumber.LongV));
                            }
                            break;
