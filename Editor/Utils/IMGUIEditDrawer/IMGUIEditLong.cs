...
{
    public static class IMGUIEditLong
    {
        public static float GetPropertyHeight(string label, Type valueType, long value, Action<object> beforeSet,
        ...
        public static void OnGUI(Rect position, string label, Type valueType, long value, Action<object> beforeSet,
            Action<object> setterOrNull, bool labelGrayColor, bool inHorizontalLayout, IReadOnlyList<object> targets,
            IRichTextTagProvider richTextTagProvider, string foldoutViewKey)
        {
