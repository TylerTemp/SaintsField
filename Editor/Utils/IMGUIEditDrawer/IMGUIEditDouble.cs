...
{
    public static class IMGUIEditDouble
    {
        public static float GetPropertyHeight(
            string label, Type valueType, double value, Action<object> beforeSet, Action<object> setterOrNull,
            ...
            string foldoutViewKey)
        {
            ...
            {
                double result = IMGUIFloat.DrawDoubleField(position, new GUIContent(label), value, inHorizontalLayout,
                    labelGrayColor);
