...
{
    public static class IMGUIEditVector3Int
    {
        public static float GetPropertyHeight(string label, Type valueType, Vector3Int value, Action<object> beforeSet,
        ...
        {
            return IMGUIVector3Int.GetHeight(inHorizontalLayout);
        }

        public static void OnGUI(Rect position, string label, Type valueType, Vector3Int value,
            ...
            IReadOnlyList<object> targets, IRichTextTagProvider richTextTagProvider, string foldoutViewKey)
        {
            ...
            {
                Vector3Int result = IMGUIVector3Int.DrawField(position, new GUIContent(label), value,
