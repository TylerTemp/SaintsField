...
{
    public static class IMGUIEditGradient
    {
        public static float GetPropertyHeight(
            string label, Type valueType, Gradient value, Action<object> beforeSet, Action<object> setterOrNull,
        ...
        {
            return IMGUIGradient.GetHeight(inHorizontalLayout);
        }
            ...
            string foldoutViewKey)
        {
            ...
            {
                Gradient result = IMGUIGradient.DrawField(position, new GUIContent(label), value, inHorizontalLayout,
                    labelGrayColor);
