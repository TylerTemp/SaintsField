...
{
    public class ResultInvoker<T0, T1, T2, TResult>: CachedInvoker
    {
        ...
        public ResultInvoker(MethodInfo method, object target, PersistentArgument[] args, object[] defaults)
            : base(args, defaults) => _call = (Func<T0, T1, T2, TResult>)CreateDelegate(typeof(Func<T0, T1, T2, TResult>), method, target);
