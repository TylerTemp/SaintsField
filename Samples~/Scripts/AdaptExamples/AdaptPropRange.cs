...
namespace SaintsField.Samples.Scripts.AdaptExamples
{
    public class AdaptPropRange : MonoBehaviour
    {
        ...
        [PropRange(0f, 1f, step: 0.05f), Adapt(EUnit.Percent), PostFieldRichLabel("%"), BelowRichLabel("$" + nameof(stepRange)), BelowButton("$" + nameof(ExternalPumpValueStep), "Pump"), BelowButton("$" + nameof(SetValue))] public float stepRange;
